...
bool testPathParser() { 
  ...
  bool t1a = true, t2a = true, t3a = true, t4a = true, t5a = true;
  bool t2b = true, t3b = true, t4b = true, t5b = true;
  if ( !t1.isValid() || !t2.isValid() || !t3.isValid() || !t4.isValid() || !t5.isValid() ) validityTest=false;
  ...
  if ( validityTest && t1a && t2a && t3a && t4a && t5a && t2b && t3b && t4b && t5b ) {
